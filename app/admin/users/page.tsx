    ...
    <div className="min-h-full bg-zinc-950 font-sans text-white">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <section className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-zinc-900/80 shadow-xl shadow-black/20 backdrop-blur-sm">
          ...
          <Link
          href="/dashboard"
          className="mb-0 mt-1 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-emerald-200 hover:border-emerald-300/30 hover:bg-emerald-500/15 hover:text-emerald-100"
        >
