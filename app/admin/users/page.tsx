...
import { Pencil, UserMinus, UserCheck, Search, ChevronLeft, ChevronRight, Users, ArrowLeft } from "lucide-react";
        ...
        <section className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-zinc-900/80 shadow-xl shadow-black/20 backdrop-blur-sm">
          ...
          <div className="relative flex items-start gap-5 px-6 py-10 sm:px-8 sm:py-12">
             <Link
                ...
                className="mb-0 mt-1 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-emerald-200 hover:border-emerald-300/30 hover:bg-emerald-400/15 hover:text-emerald-100"
              >
